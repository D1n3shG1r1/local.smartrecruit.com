...
class Controller extends BaseController
{
    ...
    function __construct(){
        ...
        if($tmpId){
            ...
            $notificationsCount = Notification_model::where('receiver', $tmpId)
            ->where('isRead', 0)
            ->count();
        ...
        view()->share('LOGINUSER',array("userId" => $tmpId, "fname" => $tmpFName, "lname" => $tmpLName,"email" => $tmpEmail, "incompleteProfile" => $incompleteProfile, "notificationsCount" => $notificationsCount, "referralCode" => $tmpReferralCode));
