                ...
                <div class="col-md-6 col-lg-6">
                    <div class="full white_shd margin_bottom_30">
                        <div class="info_people">
                            ...
                            <button id="bookmarkbtn-{{$candidateId}}" class="shortListBtn" data-id="{{$candidateId}}" data-shortlist="{{$candidate->shortlist}}" onclick="bookmark(this)"><i class="bi bi-bookmark-star @if($candidate->shortlist > 0) shortlisted @else '' @endif" data-bs-toggle="tooltip" data-bs-placement="top" title="Purchase Candidate"></i></button>
                        </div>
                    </div>
                </div>
...
function loadMore() {
        ...
        $.ajax({
            url: '{{ url("recruiter/mycandidatesloadmore") }}',
            method: 'GET',
            async:false,
            data: {
                page: currentPage,
