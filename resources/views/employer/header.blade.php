            ...
            <nav id="sidebar">
               ...
               <div class="sidebar_blog_2">
                  ...
                  <ul class="list-unstyled components">
                     <li><a href="{{url('/recruiter/dashboard')}}"><i class="fa fa-dashboard yellow_color"></i> <span>Dashboard</span></a></li>
                     <li><a href="{{url('/recruiter/notifications')}}"><i class="fa fa-bell-o yellow_color"></i> <span>Notifications</span></a></li>
                     <li><a href="{{url('/recruiter/searchcandidate')}}"><i class="fa fa-search yellow_color"></i> <span>Search Candidate</span></a></li>
                     <li><a href="{{url('/recruiter/mybookmarks')}}"><i class="bi bi bi-bookmark-star yellow_color"></i> <span>My Bookmarks</span></a></li>
                     <li><a href="{{url('/recruiter/mycandidates')}}"><i class="bi bi-clipboard-check yellow_color"></i> <span>My Candidates</span></a></li>
                     <li><a href="{{url('/recruiter/myprofile')}}"><i class="bi bi-person-vcard yellow_color"></i> <span>My Profile</span></a></li>
                     <li><a href="{{url('/recruiter/mypackage')}}"><i class="fa fa-briefcase yellow_color"></i> <span>Pricing</span></a></li>
                     <li><a href="{{url('/recruiter/logout')}}"><i class="fa fa-sign-out yellow_color"></i> <span>Logout</span></a></li>
                  </ul>
               </div>
            </nav>
