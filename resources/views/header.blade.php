...
<header
    ...
    >
      <div class="container">
        ...
        >
          <div class="w-60 lg:w-56 max-w-full px-5 topLogoW">
            <a
              href="."
              class="ic-navbar-logo block w-full py-5 text-primary-color"
            >

                <img class="w-full fill-current" id="NavbarBrand" data-name="NavbarBrand" src="{{url('images/logo.png')}}" alt="Smart Recruit"/>
            </a>
          </div>
