        ...
        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border: 1px solid #e0e0e0;">
          ...
          <tr>
            <td style="padding: 20px; font-size: 16px; line-height: 1.6; color: #333333;">
              ...
              <p>Once our admin team has completed the verification process, you will receive a follow-up email with a link to complete your video interview.</p>
              <p>We appreciate your interest and look forward to moving ahead with the next steps.</p>
            </td>
          </tr>
        </table>
      </td>
