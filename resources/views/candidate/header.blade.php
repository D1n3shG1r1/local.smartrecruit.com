            ...
            <nav id="sidebar">
               <div class="sidebar_blog_1">
                  <div class="sidebar-header">
                     <div class="logo_section">
                        <a href="{{url('/candidate/dashboard')}}"><img class="logo_icon img-responsive" src="{{url('images/logo.png')}}" alt="Smart Recruit" /></a>
                  ...
                  <div class="sidebar_user_info">
                     ...
                     <div class="user_profle_side">
                        ...
                        <img class="profilephotoimg img-responsive" src="" onerror="this.onerror=null; this.src='{{url('assets/admin/img/user.png')}}';"/></div>
                        <div class="user_info">
               ...
               <div class="sidebar_blog_2">
                  ...
                  <ul class="list-unstyled components">
                     ...
                     <li><a href="{{url('/candidate/myprofile')}}"><i class="fa fa-user yellow_color"></i> <span>My Profile</span></a></li>
                     <li><a href="{{url('/candidate/myresume')}}"><i class="fa fa-user yellow_color"></i> <span>My Resume</span></a></li>
               ...
               <div class="topbar">
                  <nav class="navbar navbar-expand-lg navbar-light">
                     <div class="full">
                        ...
                        <a href="{{url('candidate/dashboard');}}"><img class="img-responsivedk logoblackdk logoblackpngdk" src="{{url('images/logo.png')}}" alt="Smart Recruit" /></a>
                        ...
                        <div class="right_topbar">
                           <div class="icon_info">
                              ...
                              <ul class="user_profile_dd">
                                 <li>
                                    <a class="dropdown-toggle" data-toggle="dropdown"><img class="profilephotoimg img-responsive rounded-circle" src="" onerror="this.onerror=null; this.src='{{url('assets/admin/img/user-white.png')}}';" alt="#" /><span class="name_user">{{ucwords($LOGINUSER["fname"]." ".$LOGINUSER["lname"])}}</span></a>
