            ...
            <div class="col-md-12">
                ...
                <section id="about" class="about section resume">
                    ...
                    <div class="row gy-4 justify-content-center">
                        <div class="col-lg-3">
                        <img src="{{ route('private.image', ['userId' => $candidate->candidateId, 'filename' => 'pp-' . $candidate->candidateId . '.jpg']) }}" class="img-fluid" alt="">
                        </div>
